...
describe('Form Validator', () => {
  ...
  test('isValidPhone weigert ongeldig nummer', () => {
  ...
  test('isValidPostcode weigert ongeldige postcode', () => {
    expect(isValidPostcode('12 AB')).toBe(false);
  });
  ...
  test('validateForm geeft geen errors bij geldig formulier', () => {
    const result = validateForm(testData);
